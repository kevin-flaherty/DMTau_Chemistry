...
def plot_tau1(disk,tau,tau_dust):
    ...
    plt.figure()
    plt.rc('axes',lw=2)
    iphi=30#8#26 (near side of disk)#74 (far side of disk) #21,59 for DCO+
    ...
    manual_locations=[(550,120),(250,120),(400,120),(180,120)]
    cs3 = plt.contour(disk.r[iphi,:,:]/disk.AU,disk.Z[iphi,:,:]/disk.AU,disk.T[iphi,:,:],(10,15,20,25),colors='k',linestyles='-')
    ...
    cs3 = plt.contour(-disk.r[iphi,:,:]/disk.AU,disk.Z[iphi,:,:]/disk.AU,np.log10(disk.sig_col[0,:,:]),(-2,-1),linestyles=':',linewidths=3,colors='k')
    manual_locations=[(-550,120),(-250,120),(-180,120),(-400,120)]
    cs3 = plt.contour(-disk.r[iphi,:,:]/disk.AU,disk.Z[iphi,:,:]/disk.AU,disk.T[iphi,:,:],(10,15,20,25),colors='k',linestyles='-')
    cs = plt.contour(-disk.r[iphi,:,:]/disk.AU,disk.Z[iphi,:,:]/disk.AU,tau[iphi,:,:],(1,),colors='k',linestyles='--',linewidths=3)
    cs_dust = plt.contour(-disk.r[iphi,:,:]/disk.AU,disk.Z[iphi,:,:]/disk.AU,tau_dust[iphi,:,:],(1,),colors='k',linewidths=3)
    plt.plot(-disk.rf/disk.AU,disk.calcH()/disk.AU,color='m',linestyle='--')
